variable "app_name" {
  ...
  type = "string"
  default = "mobile-test-dev-1525"
}

variable "custom_domain" {
  description = "Custom domain name (optional)"
  type = "string"
  default = "mobile-test-dev-1525.botics.co"
}
...
variable "repo_url" {
    ...
    type = "string"
    default = "https://github.com/crowdbotics-apps/mobile-test-dev-1525/archive/master.tar.gz"
}
